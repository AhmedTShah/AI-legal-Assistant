...
export default function Sidebar({ chats, activeChatId, onNewChat, onSelectChat }: SidebarProps) {
  return (
    <aside className="sidebar">
      ...
      <div className="sidebar-header">
        <div className="sidebar-logo">
          ...
          <span className="sidebar-logo-text">LegalMind</span>
        </div>
        <button className="sidebar-toggle-btn" aria-label="Toggle Sidebar" id="btn-toggle-sidebar">
          {/* Outlined Sidebar toggle icon */}
      ...
      {/* ── New Chat Button (Non-colorful, transparent style) ── */}
      <button className="sidebar-new-chat" onClick={onNewChat} id="btn-new-chat">
      ...
      {/* ── Recent Chats (No icons, clean serif details) ─────── */}
